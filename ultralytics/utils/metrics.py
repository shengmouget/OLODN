...
def bbox_iou(box1,box2,xywh=True,
    ...
    if GIoU or DIoU or CIoU or SIoU or EIoU or WIoU or MPDIoU:
        cw = b1_x2.maximum(b2_x2) - b1_x1.minimum(b2_x1)
        ch = b1_y2.maximum(b2_y2) - b1_y1.minimum(b2_y1)
        if CIoU or DIoU or EIoU or SIoU or WIoU or MPDIoU:
            ...
            if CIoU:
                ...
                if scale:
                    return getattr(WIoU_Scale,'_scaled_loss')(self),(1 - iou) * torch.exp((rho2 / 2)),iou
                else:
            ...
            if Focal:
                return iou - rho2/c2,torch.pow(inter /(union + eps),gamma) # Focal_GIoU
            else:
                return iou - rho2/c2 # DIoU
        c_area = cw * ch + eps
        if Focal:
