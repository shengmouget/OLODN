...
from ultralytics.nn.modules import (AIFI, C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x,
                                    Classify, Concat, Conv, Conv2, ConvTranspose,GAM, Detect, DWConv, DWConvTranspose2d,
                                    Focus, GhostBottleneck, GhostConv, HGBlock, HGStem, Pose, RepC3, RepConv,
                                    RTDETRDecoder, Segment,C2f_EffectiveSE,SPPFCSPC,BasicStage,PatchEmbed_FasterNet,PatchMerging_FasterNet
                                    ,CBAM,CoordAtt,GSConv,VoVGSCSP,VoVGSCSPC,Conv_Mish)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 RepC3,GAM,C2f_EffectiveSE,SPPFCSPC,BasicStage,PatchEmbed_FasterNet,PatchMerging_FasterNet,CoordAtt,
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3,C2f_EffectiveSE,VoVGSCSP,VoVGSCSPC):
